...
export const metadata: Metadata = createPageMetadata({
  title: 'Voice, Messaging & Business Automation Solutions',
  description: 'Explore automation systems for calls, lead capture, appointment booking, customer support, follow-up, and controlled workflow handoffs.',
  path: '/solutions',
})
      ...
      <section className="bg-bg-base pt-32 pb-20 relative overflow-hidden border-b border-border/30">
        <div className="relative z-10 page-container max-w-4xl mx-auto">
          <AnimatedSection>
            ...
            <h1 className="font-display text-4xl sm:text-5xl md:text-7xl text-text-primary mb-6 leading-tight">Design your ideal workflow</h1>
