...
const cases = [
  ...
  { slug: 'bright-smile-dental', emoji: '🦷', title: 'Bright Smile Dental Recovered $12k/Month With Missed Call AI', company: 'Bright Smile Dental', industry: 'Dental', results: ['$12,000/month recovered', 'No-shows from 22% to 7%', 'Cancellations filled in under 5min'], solution: 'Voice Agent + Appointment Automation', color: 'from-teal-500/10 to-emerald-500/10' },
  { slug: 'foster-law', emoji: '⚖️', title: 'Foster Law Increased Consultations by 45% Without New Staff', company: 'Foster & Associates', industry: 'Legal', results: ['45% more consultations booked', 'Intake calls handled 24/7', 'Conversion rate: 28% → 61%'], solution: 'AI Voice Intake + Lead Qualification', color: 'from-accent/10 to-emerald-500/10' },
